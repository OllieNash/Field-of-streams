...
Ability to sample from Gaussian measure via K-L expansion for ICS for SPDEs 
Strong convergence checks for stochastic heat equation
Spectral method for SPDEs

**Upcoming deliverables** 
Further SDE dynamics and discreitsation schemes. 
